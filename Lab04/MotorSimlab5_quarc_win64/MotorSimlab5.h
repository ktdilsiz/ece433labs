...
#ifndef RTW_HEADER_MotorSimlab5_h_
#define RTW_HEADER_MotorSimlab5_h_
#include <stddef.h>
#include <math.h>
#include <string.h>
#ifndef MotorSimlab5_COMMON_INCLUDES_
# define MotorSimlab5_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
...
#endif                                 /* MotorSimlab5_COMMON_INCLUDES_ */

#include "MotorSimlab5_types.h"
...
#define MotorSimlab5_rtModel           RT_MODEL_MotorSimlab5_T

/* Block signals (auto storage) */
typedef struct {
  real_T Bias;                         /* '<Root>/Bias' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Motor3;                       /* '<Root>/Motor3' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } Thetascope2_PWORK;                 /* '<Root>/Theta scope2' */
...
typedef struct {
  real_T Motor3_CSTATE;                /* '<Root>/Motor3' */
...
/* State disabled  */
typedef struct {
  boolean_T Motor3_CSTATE;             /* '<Root>/Motor3' */
...
#define rtB                            MotorSimlab5_B
#define BlockIO                        B_MotorSimlab5_T
#define rtX                            MotorSimlab5_X
#define ContinuousStates               X_MotorSimlab5_T
#define rtXdot                         MotorSimlab5_XDot
#define StateDerivatives               XDot_MotorSimlab5_T
#define tXdis                          MotorSimlab5_XDis
#define StateDisabled                  XDis_MotorSimlab5_T
#define rtP                            MotorSimlab5_P
#define Parameters                     P_MotorSimlab5_T
#define rtDWork                        MotorSimlab5_DW
#define D_Work                         DW_MotorSimlab5_T

/* Parameters (auto storage) */
struct P_MotorSimlab5_T_ {
...
extern P_MotorSimlab5_T MotorSimlab5_P;

/* Block signals (auto storage) */
extern B_MotorSimlab5_T MotorSimlab5_B;

/* Continuous states (auto storage) */
extern X_MotorSimlab5_T MotorSimlab5_X;

/* Block states (auto storage) */
extern DW_MotorSimlab5_T MotorSimlab5_DW;

/* Model entry point functions */
extern void MotorSimlab5_initialize(void);
extern void MotorSimlab5_output(void);
extern void MotorSimlab5_update(void);
extern void MotorSimlab5_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern MotorSimlab5_rtModel *MotorSimlab5(void);
...
extern RT_MODEL_MotorSimlab5_T *const MotorSimlab5_M;
 ...
 * '<Root>' : 'MotorSimlab5'
 */
#endif                                 /* RTW_HEADER_MotorSimlab5_h_ */
