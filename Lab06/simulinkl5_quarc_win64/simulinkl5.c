...
RT_MODEL_simulinkl5_T *simulinkl5(void)
{
  ...
  /* External mode info */
  simulinkl5_M->Sizes.checksums[0] = (3289388151U);
  simulinkl5_M->Sizes.checksums[1] = (4228884911U);
  simulinkl5_M->Sizes.checksums[2] = (1098734860U);
  simulinkl5_M->Sizes.checksums[3] = (3827603153U);
