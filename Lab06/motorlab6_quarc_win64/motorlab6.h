...
#ifndef RTW_HEADER_motorlab6_h_
#define RTW_HEADER_motorlab6_h_
#include <string.h>
#ifndef motorlab6_COMMON_INCLUDES_
# define motorlab6_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* motorlab6_COMMON_INCLUDES_ */

#include "motorlab6_types.h"
...
#define motorlab6_rtModel              RT_MODEL_motorlab6_T
...
typedef struct {
  ...
  real_T DigitalFilter_FILT_STATES[2]; /* '<S1>/Digital Filter' */
  ...
  struct {
    void *LoggedData[3];
  } Omegalab1_PWORK;                   /* '<Root>/Omega lab1' */

  struct {
    void *LoggedData[2];
  } Omegalab2_PWORK;                   /* '<Root>/Omega lab2' */

  struct {
    void *LoggedData[3];
  } Omegalab6_PWORK;                   /* '<Root>/Omega lab6' */
...
#define rtB                            motorlab6_B
#define BlockIO                        B_motorlab6_T
#define rtX                            motorlab6_X
#define ContinuousStates               X_motorlab6_T
#define rtXdot                         motorlab6_XDot
#define StateDerivatives               XDot_motorlab6_T
#define tXdis                          motorlab6_XDis
#define StateDisabled                  XDis_motorlab6_T
#define rtP                            motorlab6_P
#define Parameters                     P_motorlab6_T
#define rtDWork                        motorlab6_DW
#define D_Work                         DW_motorlab6_T

/* Parameters (auto storage) */
struct P_motorlab6_T_ {
  ...
  boolean_T HILInitialize_set_analog_input_;/* Mask Parameter: HILInitialize_set_analog_input_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_inpu_j;/* Mask Parameter: HILInitialize_set_analog_inpu_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_analog_outp_p;/* Mask Parameter: HILInitialize_set_analog_outp_p
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_py;/* Mask Parameter: HILInitialize_set_analog_out_py
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_clock_params_;/* Mask Parameter: HILInitialize_set_clock_params_
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_clock_param_h;/* Mask Parameter: HILInitialize_set_clock_param_h
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_e;/* Mask Parameter: HILInitialize_set_digital_out_e
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_il;/* Mask Parameter: HILInitialize_set_digital_ou_il
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_pwm_params_at;/* Mask Parameter: HILInitialize_set_pwm_params_at
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_pwm_params__a;/* Mask Parameter: HILInitialize_set_pwm_params__a
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  real_T TSamp_WtEt;                   /* Computed Parameter: TSamp_WtEt
                                        ...
                                        */
  real_T TransferFcn5_A[2];            /* Computed Parameter: TransferFcn5_A
                                        * Referenced by: '<Root>/Transfer Fcn5'
                                        */
  real_T TransferFcn5_C[2];            /* Computed Parameter: TransferFcn5_C
                                        * Referenced by: '<Root>/Transfer Fcn5'
                                        */
  ...
  real_T Potentiometer_Gain;           /* Expression: (-352*pi/180)/10
                                        ...
                                        */
  real_T Step2_Time;                   /* Expression: 0.01
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_Y0;                     /* Expression: 0
                                        * Referenced by: '<Root>/Step2'
                                        */
  real_T Step2_YFinal;                 /* Expression: 7.5
                                        * Referenced by: '<Root>/Step2'
                                        */
...
extern P_motorlab6_T motorlab6_P;

/* Block signals (auto storage) */
extern B_motorlab6_T motorlab6_B;

/* Continuous states (auto storage) */
extern X_motorlab6_T motorlab6_X;

/* Block states (auto storage) */
extern DW_motorlab6_T motorlab6_DW;

/* Model entry point functions */
extern void motorlab6_initialize(void);
extern void motorlab6_output(void);
extern void motorlab6_update(void);
extern void motorlab6_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motorlab6_rtModel *motorlab6(void);
...
extern RT_MODEL_motorlab6_T *const motorlab6_M;
 ...
 *
 * '<Root>' : 'motorlab6'
 * '<S1>'   : 'motorlab6/Digital Filter Design'
 * '<S2>'   : 'motorlab6/Discrete Derivative'
 * '<S3>'   : 'motorlab6/Digital Filter Design/Check Signal Attributes'
 */
#endif                                 /* RTW_HEADER_motorlab6_h_ */
