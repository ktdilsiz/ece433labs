...
#ifndef RTW_HEADER_lab7step_h_
#define RTW_HEADER_lab7step_h_
#include <string.h>
#ifndef lab7step_COMMON_INCLUDES_
# define lab7step_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* lab7step_COMMON_INCLUDES_ */

#include "lab7step_types.h"
...
#define lab7step_rtModel               RT_MODEL_lab7step_T
...
typedef struct {
  ...
  real_T LastUAtTimeA_d;               /* '<Root>/Derivative' */
  real_T TimeStampB_m;                 /* '<Root>/Derivative' */
  real_T LastUAtTimeB_p;               /* '<Root>/Derivative' */
...
#define rtB                            lab7step_B
#define BlockIO                        B_lab7step_T
#define rtX                            lab7step_X
#define ContinuousStates               X_lab7step_T
#define rtXdot                         lab7step_XDot
#define StateDerivatives               XDot_lab7step_T
#define tXdis                          lab7step_XDis
#define StateDisabled                  XDis_lab7step_T
#define rtP                            lab7step_P
#define Parameters                     P_lab7step_T
#define rtDWork                        lab7step_DW
#define D_Work                         DW_lab7step_T

/* Parameters (auto storage) */
struct P_lab7step_T_ {
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: pi/2
                                        * Referenced by: '<Root>/Step'
                                        */
...
extern P_lab7step_T lab7step_P;

/* Block signals (auto storage) */
extern B_lab7step_T lab7step_B;

/* Continuous states (auto storage) */
extern X_lab7step_T lab7step_X;

/* Block states (auto storage) */
extern DW_lab7step_T lab7step_DW;

/* Model entry point functions */
extern void lab7step_initialize(void);
extern void lab7step_output(void);
extern void lab7step_update(void);
extern void lab7step_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern lab7step_rtModel *lab7step(void);
...
extern RT_MODEL_lab7step_T *const lab7step_M;
