...
MODEL                = MotorSimlab4
MODULES              = MotorSimlab4_data.c MotorSimlab4_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = MotorSimlab4.mk
MATLAB_ROOT          = C:\MATLAB\R2015b
ALT_MATLAB_ROOT      = C:\MATLAB\R2015b
MATLAB_BIN           = C:\MATLAB\R2015b\bin
ALT_MATLAB_BIN       = C:\MATLAB\R2015b\bin
S_FUNCTIONS          = rtiostream_utils.c
S_FUNCTIONS_LIB      = C:\Quarc\lib\win64\hil.lib C:\Quarc\lib\win64\quanser_runtime.lib C:\Quarc\lib\win64\quanser_common.lib
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 2
...
MODELLIB                  = MotorSimlab4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = MotorSimlab4_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\dilsizk\Desktop\ECE 433 labs\Lab06
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\MotorSimlab4_quarc_win64
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\dilsizk\Desktop\ECE 433 labs\Lab04
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Quarc\include
...
LDFLAGS  = $(ldebug) $(conlflags) $(NODEFAULTFLAGS) $(EXT_LIB) $(conlibs) $(CPP_LIB) winmm.lib $(STDIO_LIBS)
